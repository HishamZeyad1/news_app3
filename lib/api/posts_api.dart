...
class PostsAPI {
  ...
  Future<List<Post>> fetChPopularPostsByCollectionCategoryId(List<int> category,bool domain1) async {
    //print("******************************************");
    String whatsNewApi,postsViewByCategory_api;
    if(domain1==true){
      whatsNewApi = base_api1 + categoriesPopularPostsCollection_api ;
    }else{
      whatsNewApi = base_api + categoriesPopularPostsCollection_api ;
    }
    Map<String,String> headers = {
      "Accept" : "application/json",
      "Content-Type" : "application/x-www-form-urlencoded"
